      ...
      <main className="flex-1 py-12 md:py-20">
        <div className="container mx-auto px-4 md:px-6">
          <article className="prose dark:prose-invert max-w-4xl mx-auto">
            ...
            <p><strong>Nota sobre Bidtory Descubre:</strong> La plataforma Bidtory Descubre, enfocada en la identificación de oportunidades por suscripción, opera bajo el dominio bidtory.com y se rige por sus propios y distintos Términos y Condiciones de Servicio y Política de Privacidad. La Zona de Clientes en purocontenido.com (Bidtory Aplica) es un servicio complementario actualmente exclusivo para clientes de Puro Contenido SAS y no se ofrece como una suscripción pública independiente en este momento.</p>
